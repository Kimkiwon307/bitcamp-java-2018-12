...
public class App {
  ...
  private static void loadLessonData() {
    ...
    try (DataInputStream in = new DataInputStream(new BufferedInputStream(new FileInputStream("lesson.data")))){
  ...
  private static void loadMemberData() {
    ...
    try(
        DataInputStream in2 = new DataInputStream(new BufferedInputStream( new FileInputStream("member.data")))){
