...
// => 건물을 짓는데 필요한 기본 필드와 메서드를 서브 클래스에게 상송해주는 용도로 사용한다
// => 일부 메서드는 추상 메서드이다
// => 따라서 이 클래스는 추상 클레스이어야 한다.
...
// 즉 unit클래스는 서브 클래스가 구현해야 할 틀
// 
public abstract class Unit {

  // 건물의 type값을 지정할 때 직접 숫자를 사용하면 나중에 알아보기 힘들다.
  // 유지보수가 쉬우려면 숫자 대신 문자를 사용하는 것이 낫다.
  // 그래서 상수 변수를 활용하는 것이다.
  public static final int GENERAL_BUILDING = 0;
  public static final int DEFFENSE_BUILDING = 1;
  ...
  //  유닛의 종류에 따라 건물을 짓는 방식이 다르기 때문에 구체적인
  //   작업은 서브 클래스 에게 맡긴다
  //  따라서 bulid()가 호출하는 메서드는 추상메서드로 선언한다.
