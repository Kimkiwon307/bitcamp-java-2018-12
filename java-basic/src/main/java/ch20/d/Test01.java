...
public class Test01 {
  ...
  public static void main(String[] args) {
     ...
     // => key 객체에 대해 hashCode()를 호출하여 정수 값을 얻는다.
      ...
      //결론 : key1과 key2는 서로 다른 인스턴스이지만, hashCode()의 리턴값이 같고,
      //      equals()의 리턴 값이 ture이므로 두 인스턴스는 같은 key로 간주하낟.
      //        따라서 key1으로 저장된 값을 key2로 꺼낼수있다.
