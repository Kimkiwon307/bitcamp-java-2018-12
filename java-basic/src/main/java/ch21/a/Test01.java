...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    // => JVM이 멈추기 전에 현재까지 작업한 것을 ㅏㅁ너이마어;미ㅓㅇㄹ;ㅁ
    
    //System.out.println(sum(100000)); 실행오류
...
// 예외 클래스 계층도
// java.lang.Throwable
//          L java.lang.Error : 시스템 예외
//          L java.lang.Exception : 애플리케이션 예외
//
//
//  => catch 블록의 파라미터는 반드시 Throwable 타입이어야 한다.
//  =>  메서드 선언부에 붙이는 throws의 클래스도 throwable 타입이어야 한다.
