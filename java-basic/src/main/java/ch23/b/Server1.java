  ...
  public static void main(String[] args) throws Exception {
    try(
      ...
      try(
        ...
        //Client1 과 Sever1의 통신 규칙에 따라 순서대로 입출력 해야 한다.
        // 왜? 입출력은 blocking모드로 작동하기 때문이다.
        // 클라이언트와 서버 간의 데이터를 주고 받는 통신 규칙을 "프로토콜(protocol)"이라 한다.
        // 에코는 클라이언트에서 한 줄의 문자열을 보낸다.
        // 따라서 서버는 한 줄의 문자열을 읽은 후에 응답해야한다.
       ...
       System.out.println("데이터를 읽기 전에 잠깐!");
        ...
        // => 클라이언트가 1바이트를 보낼 때까지 리턴하지 안흔다.
        // => 한 줄의 문자열? 문자열에서 줄바꿈 코드(Line Feed ; 0x0A)를 만날때까지
