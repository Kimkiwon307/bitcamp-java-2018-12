...
public class Client1 {
  ...
  public static void main(String[] args) throws Exception{
    ...
    //  => 서버와의 연결이 이루어 지면 Socket 객체를 리턴한다.
    Socket socket = new Socket(
        "localhost",//IP 주소(ex: 234.4.5.67) 또는 도메인명 (ex: www.daum.net)
            // 특수 IP : 127.0.0.1 -로컬 컴퓨터를 가리킨다.
            // 특수 도메인 : localhost - 127.0.0.1 을 가리킨다
            //
        8888 //포트 번호 - 서버를 구분하는 식별 번호
    ...
    //       서버측에서 해당 클라이언트와 연결하기 위해 사용된 자원을 빠르게 회수하여
