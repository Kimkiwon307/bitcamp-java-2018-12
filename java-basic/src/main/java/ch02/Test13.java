// 콘솔로 출력하기 III- 형식을 갖춰서 날짜 값 추력하기
package ch02;
...
public class Test13{
    public static void main(String[] args) {
      ...
      // 그 외 다른 패키지의 멤버를 사용할 때는 반드시 패키지 이름을 함께 지정해야한다.
      ...
      // y : 날짜 및 시간 데이터에서 년도를 추출하여 뒤의 2자리로 표현한다.
       ...
       //B : 날짜 및 시간 데이터에서 월을 추출하여 전체 이름으로 표현한다. EX)january
       //B : 날짜 및 시간 데이터에서 월을 추출하여 단축 이름으로 표현한다. ex)jan
       ...
       //e:  날짜 및 시간 데이터에서 일을 추출하여 1자리 숫자로 표현한다  eX) 1, 22
       System.out.printf("%1$td %1$te\n", today);
       
       //A : 날짜 및 시간 데이터에서 요일을 추출하여 긴 이름으로 표현한다. ex) Sunday
       //a : 날짜 및 시간 데이터에서 요일을 추출하여 짧은 이름으로 표현한다. ex) Sun
        System.out.printf("%1$tA %1$ta\n", today);
       
       // H : 날짜 및 시각 데이터에서 시ㅏㄱㄱ을 추출하여 24시로 표현한다.
        //I : 날짜 및 시각 데이터에서 ㅣㅅ각을 추출하여 12시로 표현한다.
