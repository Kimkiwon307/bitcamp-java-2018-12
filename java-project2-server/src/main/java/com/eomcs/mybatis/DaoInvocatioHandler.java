...
public class DaoInvocatioHandler implements InvocationHandler{
	// SQL을 실행할 때 사용할 SqlSessionFactory를 준비
	SqlSessionFactory sqlSessionFactory;

	public DaoInvocatioHandler(SqlSessionFactory sqlSessionFactory) {
