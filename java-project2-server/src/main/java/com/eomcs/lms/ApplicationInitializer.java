...
public class ApplicationInitializer implements ApplicationContextListener {
	...
	public void contextInitialized(Map<String, Object> context) {
		try {
			//Mybaits의 SqlSessionFactory준비
			SqlSessionFactory sqlSessionFactory =
			  new SqlSessionFactoryBuilder().build( Resources.getResourceAsStream("com/eomcs/lms/conf/mybatis-config.xml"));
			

			// DAO 객체 준비
			LessonDaoImpl lessonDao = new LessonDaoImpl(sqlSessionFactory); //커밋하는건 공유하면안된다
