...
public class MemberCommand {
  ...
  public void list(ServletRequest request,ServletResponse response) throws Exception {
    ...
    out.println("<p><a href='/member/sa'>검색</a></p>");
  ...
  public void detail(ServletRequest request,ServletResponse response) throws Exception {
    ...
    out.println(String.format(
        "<tr> <th>이름</th> "
            + "<td><textarea name='name' rows='1' cols='10'>%s</textarea></td> "
            + "</tr>", member.getName()));
    out.println(String.format(
        "<tr> <th>이메일</th> "
            + "<td><textarea name='eamil' rows='1' cols='10'>%s</textarea></td> "
            + "</tr>", member.getEmail()));
    out.println(String.format(
        "<tr> <th>비밀번호</th> "
            + "<td><textarea name='password' rows='1' cols='10'>%s</textarea></td> "
            + "</tr>", member.getPassword()));

    out.println(String.format(
        "<tr> <th>사진</th> "
            + "<td><textarea name='photo' rows='1' cols='10'>%s</textarea></td> "
            + "</tr>", member.getPhoto()));
    out.println(String.format(
        "<tr> <th>전화번호</th> "
            + "<td><textarea name='tel' rows='1' cols='10'>%s</textarea></td> "
            + "</tr>", member.getTel()));
    out.println(String.format(
  ...
  public void form(ServletRequest request, ServletResponse response) throws Exception {
    ...
    out.println("  <td><textarea name='name' rows='1' cols='10'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>이메일</th>");
    out.println("  <td><textarea name='email' rows='1' cols='10'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>비밀번호</th>");
    out.println("  <td><textarea name='password' rows='1' cols='10'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>사진</th>");
    out.println("  <td><textarea name='photo' rows='1' cols='10'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("  <th>전화번호</th>");
    out.println("  <td><textarea name='tel' rows='1' cols='10'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("</table>");
    out.println("<p>");
  ...
  @RequestMapping("/member/sa")
  public void sa(ServletRequest request, ServletResponse response) throws Exception {
    PrintWriter out = response.getWriter();

    out.println("<htm>");
    out.println("<head><title>검색</title></head>");
    out.println("<body>");
    out.println("<h1>검색</h1>");
    out.println("<form action='/member/search'>");
    out.println("<table border='1'>");
    out.println("<tr>");
    out.println("  <th>검색어</th>");
    out.println("  <td><textarea name='name' rows='1' cols='10'></textarea></td>");
    out.println("</tr>");
    out.println("<tr>");
    out.println("</table>");
